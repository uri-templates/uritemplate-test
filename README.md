...
Note that RFC 6570 does not specify the case for percent encoding sequences.
This is why two directories exist, with the same tests: `uc` if you use upper
case (ex: `%2F`), `lc` if you use lower case (ex: `%2f`).
